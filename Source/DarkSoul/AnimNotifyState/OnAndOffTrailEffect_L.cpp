#include "OnAndOffTrailEffect_L.h"
...
void UOnAndOffTrailEffect_L::NotifyBegin(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation, float TotalDuration)
{
